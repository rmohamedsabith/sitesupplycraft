          ...
          <div style={{ display: 'table', margin: '20px auto' }}>
            <form style={{ display: 'table-row' }}>
              <div style={{ display: 'table-row' }}>
                ...
                <input type="text" id="seller_id" name="seller_id" defaultValue={user?._id} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="full_name" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>Owner/Full Name:</label>
                <input type="text" id="full_name" name="full_name" defaultValue={user?.firstname + " " + user?.lastname} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="license_no" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>Shop Registration No:</label>
                <input type="text" id="license_no" name="license_no" defaultValue={user?.shopReg_no} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="email" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>E-mail:</label>
                <input type="email" id="email" name="email" defaultValue={user?.email} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="phone_no" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>Phone No.:</label>
                <input type="tel" id="phone_no" name="phone_no" defaultValue={user?.phone} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="address" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>Address:</label>
                <input type="text" id="address" name="address" defaultValue={user?.address.number + " " + user?.address.street} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="city" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>City:</label>
                <input type="text" id="city" name="city" defaultValue={user?.address.city} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="district" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>District:</label>
                <input type="text" id="district" name="district" defaultValue={user?.address.district} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} required />
              </div>
              <div style={{ display: 'table-row' }}>
                <label htmlFor="landmark" style={{ display: 'table-cell', padding: '5px', verticalAlign: 'top' }}>Postal Code:</label>
                <input type="text" id="landmark" name="landmark" defaultValue={user?.address.postalCode} style={{ display: 'table-cell', padding: '5px',border:'none',borderBottom:'2px solid green' }} />
              </div>
            </form>
          </div>
