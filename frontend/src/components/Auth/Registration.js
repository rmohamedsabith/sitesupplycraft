            ...
            <div className='card p-3 mx-0 inside'>
              <div className="row" style={{margin:'20px'}}>
                <div className="col-md-12">
                  <h2 style={{color:'#053B50'}} >Create a {role}  Account</h2>
...
g
                        ...
                        <div className="mb-3">
                          <div className='float'>     
                            <div style={{ paddingLeft: '10px',width:'400px' }}>
                              ...
                              <FloatingLabel controlId="floatingInput" label="Resident Number" className="mb-3 z-0">
                              ...
                              <FloatingLabel controlId="floatingInput" label="District" className="mb-3 z-0">
                                <Form.Select aria-label='district' name='district' value={formData.district} onSelect={handleDistrictSelect} onChange={handleInput}>
                    ...
                    <div className="mb-3">
                      <div className='float'>     
                        <div style={{ paddingLeft: '10px',width:'400px' }}>
                          ...
                          <FloatingLabel controlId="floatingInput" label="Street Name" className="mb-3 z-0">
                          ...
                          <FloatingLabel controlId="floatingInput" label="City" className="mb-3 z-0">
                            <Form.Select aria-label='city' name='city' value={formData.city} onSelect={handleCitySelect} onChange={handleInput}>
                  ...
                  <div style={{ paddingLeft: '10px',width:'400px' }}>
                    {formError.location&&formData.lat<=0&&formData.long<=0 ? <div className='error'>{formError.location}</div>:""}
                      <FloatingLabel controlId="floatingInput" label="Latitude" className="mb-3 z-0">
                ...
                <div className="col-md-4">
                  <div className="mb-3">
                    <div className='float'>    
                    {formError.location&&formData.lat<=0&&formData.long<=0 ? <div className='error'>{formError.location}</div>:""}
                    <FloatingLabel controlId="floatingInput" label="Longtitude" className="mb-3 z-0">
